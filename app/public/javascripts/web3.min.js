        ...
        ! function(r, o, i) {
            ...
            return function() {
                ...
                var m = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                    y = o.AES = r.extend({
                        _doReset: function() {
                            for (var t = this._key, e = t.words, n = t.sigBytes / 4, r = this._nRounds = n + 6, o = 4 * (r + 1), a = this._keySchedule = [], s = 0; s < o; s++)
                                if (s < n) a[s] = e[s];
                                else {
                                    var c = a[s - 1];
                ...
                var h = c.SHA3 = i.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        ...
                        for (var c = 0; c < 24; c++) {
                            ...
                            for (var h = 0; h < 5; h++)
                                for (var v = l[(h + 4) % 5], b = l[(h + 1) % 5], _ = b.high, w = b.low, d = v.high ^ (_ << 1 | w >>> 31), m = v.low ^ (w << 1 | _ >>> 31), y = 0; y < 5; y++) {
                                    var s = n[h + 5 * y];
                                    s.high ^= d, s.low ^= m
                                }
                            for (var x = 1; x < 25; x++) {
        ...
        ! function(n) {
            ...
            function r(t) {
                ...
                function n(t, n, r, o) {
                    ...
                    if (!h[0]) return "0";
                    if (m < 0 ? --s : (l.c = h, l.e = s, l.s = o, l = P(l, d, y, g, n), h = l.c, f = l.r, s = l.e), a = s + y + 1, m = h[a], c = n / 2, f = f || a < 0 || null != h[a + 1], f = g < 4 ? (null != m || f) && (0 == g || g == (l.s < 0 ? 3 : 2)) : m > c || m == c && (4 == g || f || 6 == g && 1 & h[a - 1] || g == (l.s < 0 ? 8 : 7)), a < 1 || !h[0]) t = f ? p("1", -y) : "0";
                    else {
                        if (h.length = a, f)
                ...
                function h(t, n, r, o) {
                    ...
                    if (a = t.c[0], c = t.e, null == n) l = i(t.c), l = 19 == o || 24 == o && c <= q ? f(l, c) : p(l, c);
                    else if (t = T(new e(t), n, r), s = t.e, l = i(t.c), u = l.length, 19 == o || 24 == o && (n <= s || s <= q)) {
                        for (; u < n; l += "0", u++);
                        l = f(l, s)
                ...
                return e.another = r, e.ROUND_UP = 0, e.ROUND_DOWN = 1, e.ROUND_CEIL = 2, e.ROUND_FLOOR = 3, e.ROUND_HALF_UP = 4, e.ROUND_HALF_DOWN = 5, e.ROUND_HALF_EVEN = 6, e.ROUND_HALF_CEIL = 7, e.ROUND_HALF_FLOOR = 8, e.EUCLID = 9, e.config = function() {
                            ...
                            do {
                                if (d = 0, f = n(D, _, F, w), f < 0) {
                                    if (x = _[0], F != w && (x = x * u + (_[1] || 0)), d = v(x / C), d > 1)
                                        for (d >= u && (d = u - 1), m = t(D, d, u), y = m.length, w = _.length; 1 == n(m, _, y, w);) d--, r(m, F < y ? I : D, y, u), y = m.length, f = 1;
                                    else 0 == d && (f = d = 1), m = D.slice(), y = m.length;
                                    if (y < w && m.unshift(0), r(_, m, w, u), w = _.length, f == -1)
                                        for (; n(D, _, F, w) < 1;) d++, r(_, F < w ? I : D, w, u), w = _.length
                                } else 0 === f && (d++, _ = [0]);
                    ...
                    return function(a, s, c, u) {
                        ...
                        if (o.test(p)) a.s = isNaN(p) ? null : p < 0 ? -1 : 1;
                        else {
                    ...
                    if (f = o(f), p = o(p), l = l.slice(), u = f - p) {
                        ...
                        for (i = (s = (u = l.length) < (n = h.length)) ? u : n, u = n = 0; n < i; n++)
                            if (l[n] != h[n]) {
                                s = l[n] < h[n];
                                break
                    ...
                    if (f = Math.sqrt(+c), 0 == f || f == 1 / 0 ? (n = i(u), (n.length + p) % 2 == 0 && (n += "0"), f = Math.sqrt(n), p = o((p + 1) / 2) - (p < 0 || p % 2), f == 1 / 0 ? n = "1e" + p : (n = f.toExponential(), n = n.slice(0, n.indexOf("e") + 1) + p), r = new e(n)) : r = new e(f + ""), r.c[0])
                        for (p = r.e, f = p + l, f < 3 && (f = 0);;)
