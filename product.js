...
require('./app/backend/bookmark.js')(app, passport);
require('./app/backend/settings.js')(app, passport);
require('./app/backend/posts.js')(app, passport);
require('./app/backend/whitelist.js')(app, passport,paginate);
require('./app/backend/blockchain.js');
require('./app/backend/verify.js')(app, passport);
...
var fs = require('fs');
// Certificate
const privateKey = fs.readFileSync('/etc/letsencrypt/live/ledger.easternblu.com/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/ledger.easternblu.com/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/ledger.easternblu.com/chain.pem', 'utf8');
...
// server.listen(443);
require('./app/backend/socket-server.js')(app, io);
// app.listen(8000);
